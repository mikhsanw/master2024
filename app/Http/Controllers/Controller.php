...
class Controller extends BaseController
{
    ...
    function __construct()
    {
        ...
        $this->code = app('App\Helpers\Helper')->menu()->code ?? 'dashboard';
        $this->model = app('App\Helpers\Helper')->menu()->model ?? 'dashboard';
        $this->url = app('App\Helpers\Helper')->menu()->url ?? 'dashboard';

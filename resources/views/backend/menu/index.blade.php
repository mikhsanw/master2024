...
<div class="card">
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <a href="#" class="btn btn-sm btn-primary btn-action" data-title="Tambah" data-action="create" data-url="{!! $page->url !!}">
    ...
    <div class="card-body py-4">
        <div class="panel-container show">
            <div class="panel-content">
                {!! html()->form('POST', route($page->url.'.sorted'))->id('myForm')->acceptsFiles()->class('form form-horizontal')->open() !!}

...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {!! html()->select('model', $model)->placeholder('Pilih Model (optional)')->class('form-select select2')->id('model') !!}
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="export">
                ...
                <input type="hidden" id="IconInput" name="icon" placeholder="Hidden etc. input for icon classname" autocomplete="off" spellcheck="false" />
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="form-group">
            {!! html()->label('Yang dapat mengakses menu ini ?','role_id')->class('control-label') !!}
            <span class="text-danger">*</span>
            <div class="row p-5" id="role_id">
                @foreach($role as $key => $value)
                    <div class="col-12">
                        <input type="checkbox" name="role_id[]" onclick="checkAllLevel('access-menu-crud-{{$key}}',this)" value="{{ $key }}" id="md_checkbox_{{$key}}" class="filled-in chk-col-primary role_id">
                        ...
                        <div class="form-control access-menu-crud-{{$key}} m-2" style="display: none;">
                            ...
                            <a href="javascript:void(0)" type="button" onclick="checkAll('access-crud-{{$key}}',{{$key}})" class="check-all-{{$key}} btn btn-sm btn-success"><i class="fa fa-check"></i> Check All</a>
                            <div class="row mt-2">

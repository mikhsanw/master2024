        ...
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" id="search" data-kt-docs-table-filter="search"
                    class="form-control form-control-solid w-250px ps-15" placeholder="Search {{$page->title}}" />
            </div>
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                @can($page->code.' create')
                    <a href="#" class="btn btn-primary btn-action" data-title="Tambah" data-action="create" data-url="{!! $page->url !!}">
